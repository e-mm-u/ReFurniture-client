...
const Categories = () => {
    ...
    return (
        <div className='border border-navy-600 border-5'>
            <div className='my-5 p-5'>
                <h1 className="font-bold text-xl divider uppercase">choose product category</h1>
            </div>
            <div className='flex flex-wrap justify-center align-center gap-10'>
                <Link to={`/products/category/${categories[0]}`}>
                    <div className='btn btn-lg bg-red-400 hover:bg-green-400 w-80 sm:w-96'>
                        BED ROOM
                    </div>
                </Link>
